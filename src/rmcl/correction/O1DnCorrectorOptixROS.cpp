#include "rmcl/correction/O1DnCorrectorOptixROS.hpp"
...
void O1DnCorrectorOptixROS::setInputData(const std::vector<float>& ranges)
{
...
void O1DnCorrectorOptixROS::setTsb(
...
void O1DnCorrectorOptixROS::setTFBuffer(
