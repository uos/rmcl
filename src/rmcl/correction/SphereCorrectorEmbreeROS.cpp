...
void SphereCorrectorEmbreeROS::setModel(const rmcl_msgs::msg::ScanInfo& info)
{
...
void SphereCorrectorEmbreeROS::setTsb(const geometry_msgs::msg::Transform& Tsb)
{
    ...
    const std::string& base_frame)
{
    if(!m_tf_buffer)
    {
        ...
        auto log = rclcpp::get_logger("rmcl::SphereCorrectorEmbreeROS");
