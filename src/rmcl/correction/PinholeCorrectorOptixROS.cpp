...
void PinholeCorrectorOptixROS::setInputData(const std::vector<float>& ranges)
{
    ...
    rm::Memory<float, rm::VRAM_CUDA> ranges_rm_vram;
    ranges_rm_vram = ranges_rm;
...
void PinholeCorrectorOptixROS::setTsb(
...
void PinholeCorrectorOptixROS::setTFBuffer(
