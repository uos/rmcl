#ifndef RMCL_MCL_PCD_SENSOR_UPDATER_OPTIX_HPP
#define RMCL_MCL_PCD_SENSOR_UPDATER_OPTIX_HPP
...
private:
  ...
  rmagine::CudaStreamPtr  stream_;

  // rmagine::Memory<EvaluationParams, rmagine::VRAM_CUDA> m_params;
...
#endif // RMCL_MCL_PCD_SENSOR_UPDATER_OPTIX_HPP
