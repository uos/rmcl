...
class pcdToScanNode : public rclcpp::Node
{
public:
  explicit pcdToScanNode(const rclcpp::NodeOptions& options = rclcpp::NodeOptions())
  :rclcpp::Node("pcd2_to_scan_node", rclcpp::NodeOptions(options)
...
RCLCPP_COMPONENTS_REGISTER_NODE(rmcl::pcdToScanNode)
