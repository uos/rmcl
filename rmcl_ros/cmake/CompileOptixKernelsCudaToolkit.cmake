...
foreach(OPTIX_KERNEL_FILE ${OPTIX_KERNEL_FILES})
    ...
    file(READ "${CMAKE_CURRENT_BINARY_DIR}/CMakeFiles/rmcl_ros_optix_cu_to_ptx.dir/src/rmcl/optix/${OPTIX_KERNEL_NAME}.ptx" INCLUDE_STRING)

    # Write to static readable file e.g. R("")
    configure_file(${RMCL_ROS_SOURCE_DIR}/cmake/FileToString.h.in "include/kernels/${OPTIX_KERNEL_NAME}String.h")
